...
- [1. Resumo](#1-resumo)
  - [1.1 Desenvolvimento na AWS (Módulo 2)](#11-desenvolvimento-na-aws-módulo-2)
  - [1.2 Amazon S3 — Armazenamento (Módulo 3)](#12-amazon-s3--armazenamento-módulo-3)
  - [1.3 IAM — Segurança (Módulo 4)](#13-iam--segurança-módulo-4)
  - [1.4 DynamoDB — NoSQL (Módulo 5)](#14-dynamodb--nosql-módulo-5)
  - [1.5 API Gateway — REST APIs (Módulo 6)](#15-api-gateway--rest-apis-módulo-6)
  - [1.6 AWS Lambda — Serverless (Módulo 7)](#16-aws-lambda--serverless-módulo-7)
  - [1.7 Containers (Módulo 8)](#17-containers-módulo-8)
  - [1.8 Caching — ElastiCache e CloudFront (Módulo 9)](#18-caching--elasticache-e-cloudfront-módulo-9)
  - [1.9 Mensageria — SQS e SNS (Módulo 10)](#19-mensageria--sqs-e-sns-módulo-10)
  - [1.10 Step Functions — Orquestração (Módulo 11)](#110-step-functions--orquestração-módulo-11)
  - [1.11 Segurança de Aplicações — Cognito e STS (Módulo 12)](#111-segurança-de-aplicações--cognito-e-sts-módulo-12)
  - [1.12 CI/CD — Deploy Automatizado (Módulo 13)](#112-cicd--deploy-automatizado-módulo-13)
- [2. Revisão Completa](#2-revisão-completa)
  - [2.1 Desenvolvimento na AWS e SDKs](#21-desenvolvimento-na-aws-e-sdks)
  - [2.2 Amazon S3](#22-amazon-s3-simple-storage-service)
  - [2.3 IAM](#23-iam-identity-and-access-management)
  - [2.4 Amazon DynamoDB](#24-amazon-dynamodb)
  - [2.5 Amazon API Gateway](#25-amazon-api-gateway)
  - [2.6 AWS Lambda](#26-aws-lambda)
  - [2.7 Containers](#27-containers-e-serviços-de-container)
  - [2.8 Caching](#28-caching--elasticache-e-cloudfront)
  - [2.9 Mensageria](#29-mensageria--sqs-e-sns)
  - [2.10 Step Functions](#210-aws-step-functions)
  - [2.11 Segurança de Aplicações](#211-segurança-de-aplicações-cognito-sts-acm)
  - [2.12 CI/CD e Deploy](#212-cicd-e-deploy-cloudformation-sam-codepipeline)
  - [2.13 EC2 e Docker](#213-ec2-e-docker-projetos-práticos)
  - [2.14 VPC](#214-vpc-virtual-private-cloud--projeto-prático)
  - [2.15 IoT, Grafana e Node-RED](#215-iot-grafana-e-node-red-projetos-práticos)
- [3. Tabelas Comparativas](#3-tabelas-comparativas)
- [4. Decore Antes da Prova](#4-decore-antes-da-prova)
  - [4.1 Conceitos Essenciais](#41-conceitos-essenciais)
  - [4.2 Pegadinhas Comuns](#42-pegadinhas-comuns-baseadas-nas-perguntas-do-curso)
  - [4.3 Respostas-Chave das Provas](#43-respostas-chave-das-provas-dos-módulos)
  - [4.4 Formas de Cobrança AWS](#44-formas-de-cobrança-aws)
  - [4.5 Códigos HTTP](#45-códigos-http-importantes)
